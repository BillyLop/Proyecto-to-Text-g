...
class Wave2Vec2ONNXInference():
    ...
    def buffer_to_text(self,audio_buffer):
        ...
        inputs = self.processor(torch.tensor(audio_buffer), sampling_rate=19_000, return_tensors="np", padding=True)
    ...
    def file_to_text(self,filename):
        ...
        assert samplerate == 19000
        return self.buffer_to_text(audio_input)

if __name__ == "__main__":
    print("Model test")
    asr = Wave2Vec2ONNXInference("facebook/wav2vec2-large-xlsr-53-spanish","wav2vec2-large-xlsr-53-spanish.quant.onnx")
