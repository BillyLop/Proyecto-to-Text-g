...
if __name__ == "__main__":
    ...
    asr_onnx_opt = Wave2Vec2ONNXInference(base_model,"facebook/wav2vec2-large-xlsr-53-spanish-opt.onnx")
    asr_onnx_quant = Wave2Vec2ONNXInference(base_model,"facebook/wav2vec2-large-xlsr-53-spanish.quant.onnx")
    asr_onnx = Wave2Vec2ONNXInference(base_model,"facebook/wav2vec2-large-xlsr-53-spanish.onnx")
