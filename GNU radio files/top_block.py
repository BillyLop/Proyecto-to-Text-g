...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.signal_bandwidth = signal_bandwidth = 4000000
        self.samp_rate = samp_rate = 200000
        self.rx_gain = rx_gain = 59
        self.center_freq = center_freq = 89.7e6

        ##################################################
        # Blocks
        ##################################################
        self._volume_range = Range(0, 1, 0.01, 0.4, 200)
        ...
        self._rx_gain_range = Range(0, 70, 1, 59, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.samp_rate/2), (self.samp_rate/2.75), firdes.WIN_HAMMING, 6.76))
